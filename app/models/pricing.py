...
class TenantSubscription(Base):
    ...
    dunning_next_retry_at: Mapped[Optional[datetime]] = mapped_column(DateTime(timezone=True))
...
class LLMProviderPricing(Base):
    ...
    input_cost_per_million: Mapped[float] = mapped_column(Numeric(10, 4), nullable=False)
    output_cost_per_million: Mapped[float] = mapped_column(Numeric(10, 4), nullable=False)
