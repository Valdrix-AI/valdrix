...
SCHEDULER_JOB_RUNS = Counter(
    "valdrics_scheduler_job_runs_total",
...
SCHEDULER_JOB_DURATION = Histogram(
    "valdrics_scheduler_job_duration_seconds",
...
SCHEDULER_DEADLOCK_DETECTED = Counter(
    "valdrics_scheduler_deadlock_detected_total",
...
BACKGROUND_JOBS_ENQUEUED_SCHEDULER = Counter(
    "valdrics_scheduler_jobs_enqueued_total",
