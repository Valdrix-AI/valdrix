                    ...
                    for reservation in page.get("Reservations", []):
                        for instance in reservation.get("Instances", []):
                            ...
                            if days_stopped >= days_stopped_threshold and volume_ids:
                                ...
                                try:
                                    vol_response = await ec2.describe_volumes(
...
class UnusedLambdaPlugin(ZombiePlugin):
    ...
    **kwargs: Any,
        ...
        try:
            async with self._get_client(
                session, "lambda", region, credentials, config=config
            ) as lambda_client:
                async with self._get_client(
                        ...
                        for func in page.get("Functions", []):
                            ...
                            try:
                                ...
                                total_invocations = sum(
                                    d.get("Sum", 0) for d in datapoints
                                )
                    ...
                    async for page in paginator.paginate():
                        for endpoint in page.get("VpcEndpoints", []):
                            ...
                            try:
                                ...
                                logger.warning(
                                    "vpc_endpoint_metric_fetch_failed",
