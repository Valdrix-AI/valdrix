...
class ZombieDetectorFactory:
    ...
    @staticmethod
    def get_detector(
        connection: Any, region: str = "us-east-1", db: Optional[AsyncSession] = None
    ) -> BaseZombieDetector:
        ...
        elif "SaaSConnection" in type_name or provider == "saas":
            return SaaSZombieDetector(region="global", connection=connection, db=db)

        elif "LicenseConnection" in type_name or provider == "license":
