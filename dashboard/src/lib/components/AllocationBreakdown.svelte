<script lang="ts">
  ...
  import { TrendingUp, Users, AlertTriangle } from '@lucide/svelte';
  ...
  {:else}
    <div class="content-grid">
      ...
      <div class="chart-section">
        <PieChart 
          data={chartData()}
          title="Allocated vs Unallocated"
          height={280}
        />
      </div>
      ...
      <div class="table-section">
        ...
        <table>
          ...
          <tbody>
            {#each bucketsWithPercentage() as bucket}
          ...
          <tfoot>
            <tr>
              ...
              <td class="count">{data.buckets.reduce((s, b) => s + b.record_count, 0).toLocaleString()}</td>
...
<style>
  ...
  .icon-lg { width: 48px; height: 48px; color: #64748b; }
