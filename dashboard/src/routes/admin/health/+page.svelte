...
<div class="p-8 space-y-6 page-enter">
  ...
  <div class="card mt-8">
    ...
    <div class="rounded-md border border-ink-800 p-4 font-mono text-sm">
      <div class="text-accent-400">[INFO] 2026-01-16 10:45:00 - Job#7782 started: finops_analysis for tenant_123</div>
      <div class="text-success-400">[SUCCESS] 2026-01-16 10:44:55 - Webhook retry successful: Paystack#REF_9982</div>
      <div class="text-danger-400">[ERROR] 2026-01-16 10:44:00 - Groq API Rate Limit Hit (Fallback to Gemini initialized)</div>
      <div class="text-warning-400">[WARN] 2026-01-16 10:43:55 - Delta Analysis skipped: No previous cache found for tenant_445</div>
    </div>
  </div>
</div>
