...
class TestCarbonCalculation:
    ...
    def test_low_carbon_region(self):
        ...
        cost_data = [{"Total": {"UnblendedCost": {"Amount": "100.00"}}}]
    ...
    def test_high_carbon_region(self):
        ...
        result_stockholm = calculator.calculate_from_costs(
            cost_data, region="eu-north-1"
        )
    ...
    def test_zero_cost_returns_zero_carbon(self):
        ...
        cost_data = [{"Total": {"UnblendedCost": {"Amount": "0.00"}}}]
...
class TestEquivalencies:
    ...
    def test_equivalencies_scale_with_carbon(self):
        ...
        cost_data_small = [{"Total": {"UnblendedCost": {"Amount": "10.00"}}}]
        cost_data_large = [{"Total": {"UnblendedCost": {"Amount": "100.00"}}}]
        ...
        ratio = (
            result_large["equivalencies"]["miles_driven"]
            / result_small["equivalencies"]["miles_driven"]
        )
