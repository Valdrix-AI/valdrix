...
class TestDeltaAnalysisResult:
    ...
    def test_has_significant_changes_with_increases(self):
        ...
        result = DeltaAnalysisResult(
            ...
            top_increases=[CostDelta("ec2-1", "EC2", 100, 130, 30, 30)],
        )
    ...
    def test_as_json_serializes(self):
        ...
        result = DeltaAnalysisResult(tenant_id=uuid4(), analysis_date=date.today())
...
class TestDeltaAnalysisService:
    ...
    async def test_compute_delta_with_increases(self):
        ...
        current = [
            {
                ...
                "Groups": [
                    {
                        "Keys": ["EC2", "i-123"],
                        "Metrics": {"UnblendedCost": {"Amount": "150"}},
                    }
                ],
            }
        ]
        ...
        result = await service.compute_delta(
            tenant_id=uuid4(), current_costs=current, previous_costs=previous
        )
        ...
        current = [
            {
                ...
                "Groups": [
                    {
                        "Keys": ["RDS", "newdb"],
                        "Metrics": {"UnblendedCost": {"Amount": "50"}},
                    }
                ],
            }
        ]
        ...
        current = [
            {
                ...
                "Groups": [
                    {
                        "Keys": ["S3", "bucket"],
                        "Metrics": {"UnblendedCost": {"Amount": "10.10"}},
                    }
                ],
            }
        ]
    ...
    async def test_returns_cached_result_when_available(self):
        ...
        with patch(
            ...
            result = await analyze_with_delta(
                analyzer=mock_analyzer, tenant_id=tenant_id, current_costs=[]
            )
