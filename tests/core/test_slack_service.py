...
class TestSlackService:
    ...
    def slack_service(self, mock_web_client):
        ...
        service = SlackService(bot_token="xoxb-test-token", channel_id="C12345678")
        return service
...
class TestSendAlert:
    ...
    async def test_send_alert_info_severity(self):
        ...
        with patch(
            "app.modules.notifications.domain.slack.AsyncWebClient"
        ) as mock_client:
    ...
    async def test_send_alert_critical_severity(self):
        ...
        with patch(
            ...
            service = SlackService("xoxb-test", "C123")
            result = await service.send_alert(
                title="Critical Alert", message="Budget exceeded!", severity="critical"
            )
    ...
    async def test_send_alert_api_failure(self):
        ...
        with patch(
            ...
            service = SlackService("xoxb-test", "C123")
            result = await service.send_alert(
                title="Test", message="Test", severity="info"
            )
