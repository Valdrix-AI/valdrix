...
@pytest.fixture
def mock_pricing():
    with patch("app.modules.optimization.adapters.aws.plugins.database.PricingService") as mock:
...
async def test_database_plugins_cur_path():
    ...
    with patch("app.shared.analysis.cur_usage_analyzer.CURUsageAnalyzer") as mock_analyzer_cls:
        ...
        mock_analyzer.find_idle_rds_databases.return_value = [{"resource_id": "cur-rds"}]
