...
class TestCURUsageAnalyzer:
    ...
    def test_find_low_usage_instances_exhaust_branches(self):
        records = [
            ...
            {"line_item_product_code": "WrongService", "line_item_usage_type": "BoxUsage"},
            # Record with wrong usage type
            {"line_item_product_code": "AmazonEC2", "line_item_usage_type": "DataTransfer"},
            # Record with wrong resource ID prefix
            {"line_item_product_code": "AmazonEC2", "line_item_usage_type": "BoxUsage", "line_item_resource_id": "other-id"},
            # Valid idle instance
            {
                "line_item_resource_id": "i-123",
    ...
    def test_find_unused_ebs_volumes_negative(self):
        records = [
            ...
            {"line_item_product_code": "AmazonEC2", "line_item_usage_type": "BoxUsage"}, # Wrong usage type
            {
                "line_item_resource_id": "vol-unused",
    ...
    def test_find_idle_redshift_negative(self):
        records = [
            {"line_item_product_code": "AmazonRDS"},
            {"line_item_product_code": "AmazonRedshift", "line_item_usage_type": "Storage"},
            {
    ...
    def test_find_idle_sagemaker_negative(self):
        records = [
            {"line_item_product_code": "AmazonEC2"},
            {"line_item_product_code": "AmazonSageMaker", "line_item_usage_type": "Training"},
            {
                "line_item_resource_id": "sm-idle",
                "line_item_product_code": "AmazonSageMaker",
    ...
    def test_find_idle_elasticache_negative(self):
        records = [
            {"line_item_product_code": "AmazonRDS"},
            {"line_item_product_code": "AmazonElastiCache", "line_item_usage_type": "Storage"},
            {
                "line_item_resource_id": "cache-idle",
                "line_item_product_code": "AmazonElastiCache",
...
class TestAzureUsageAnalyzer:
    def test_find_idle_vms_negative(self):
        records = [
            ...
            {"ResourceId": "microsoft.compute/virtualmachines/vm1", "ServiceName": "Storage"}, # Wrong service
            {"ResourceId": "microsoft.compute/virtualmachines/vm-idle", "ServiceName": "Virtual Machines", "PreTaxCost": 60.0, "MeterCategory": "Virtual Machines"}
        ]
    ...
    def test_find_unattached_disks_negative(self):
        records = [
            ...
            {"ResourceId": "microsoft.compute/disks/d1", "MeterCategory": "Bandwidth"}, # Wrong category
            {"ResourceId": "microsoft.compute/disks/d-orphan", "MeterCategory": "Managed Disks", "PreTaxCost": 10.0}
        ]
        analyzer = AzureUsageAnalyzer(records)
    ...
    def test_find_idle_sql_negative(self):
        records = [
            {"ResourceId": "other"},
            {"ResourceId": "microsoft.sql/servers/s1/databases/db1", "ServiceName": "Storage"}, # Wrong service
            {"ResourceId": "microsoft.sql/servers/s1/databases/db-idle", "ServiceName": "Azure SQL Database", "PreTaxCost": 10.0, "MeterName": "vCore"}
        ]
        analyzer = AzureUsageAnalyzer(records)
    ...
    def test_find_idle_aks_negative(self):
        records = [
            {"ResourceId": "other"},
            {"ResourceId": "microsoft.containerservice/managedclusters/c1", "ServiceName": "Storage"}, # Wrong service
            {"ResourceId": "/subscriptions/s1/resourceGroups/g1/providers/Microsoft.ContainerService/managedClusters/aks-idle", "ServiceName": "Azure Kubernetes Service", "PreTaxCost": 70.0, "MeterName": "Uptime SLA"}
        ]
        analyzer = AzureUsageAnalyzer(records)
    ...
    def test_find_orphan_ips_negative(self):
        records = [
            {"ResourceId": "other"},
            {"ResourceId": "microsoft.network/publicipaddresses/ip1", "MeterName": "Other"}, # Wrong meter
            {"ResourceId": "microsoft.network/publicipaddresses/ip-orphan", "MeterName": "Static IP Address", "PreTaxCost": 5.0}
        ]
        analyzer = AzureUsageAnalyzer(records)
    ...
    def test_find_unused_app_service_negative(self):
        records = [
            ...
            {"ResourceId": "microsoft.web/serverfarms/plan-idle", "ServiceName": "App Service", "PreTaxCost": 10.0}
        ]
        analyzer = AzureUsageAnalyzer(records)
    ...
    def test_find_old_snapshots_negative(self):
        records = [
            ...
            {"ResourceId": "microsoft.compute/snapshots/snap-old", "MeterCategory": "Disk Snapshots", "PreTaxCost": 5.0}
        ]
        analyzer = AzureUsageAnalyzer(records)
    ...
    def test_find_orphan_nics(self):
        ...
        analyzer = AzureUsageAnalyzer([{"ResourceId": "microsoft.network/networkinterfaces/nic1"}])
