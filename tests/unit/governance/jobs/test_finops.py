...
async def test_finops_analysis_handler():
    ...
    db.execute = AsyncMock(side_effect=[aws_result, empty_result, empty_result, empty_result, empty_result])
    ...
    with patch("app.modules.governance.domain.jobs.handlers.finops.AdapterFactory") as mock_factory, \
         ...
         patch("app.modules.governance.domain.jobs.handlers.finops.FinOpsAnalyzer") as MockAnalyzer:
