...
class TestCostAggregator:
    ...
    async def test_get_dashboard_summary(self, mock_db, tenant_id):
        ...
        mock_breakdown_rows = [
            MagicMock(
                ...
                total_carbon=Decimal("30.00"),
            ),
            MagicMock(
                service="s3", total_cost=Decimal("40.00"), total_carbon=Decimal("20.00")
            ),
        ]
    ...
    async def test_get_basic_breakdown(self, mock_db, tenant_id):
        ...
        mock_rows = [
            MagicMock(
                ...
                total_carbon=Decimal("10.00"),
            ),
            MagicMock(
                service="lambda",
                total_cost=Decimal("20.00"),
                total_carbon=Decimal("5.00"),
            ),
        ]
    ...
    async def test_get_governance_report(self, mock_db, tenant_id):
        ...
        with patch(
            ...
            mock_engine_instance.get_unallocated_analysis = AsyncMock(
