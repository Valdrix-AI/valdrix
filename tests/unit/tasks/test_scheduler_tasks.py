...
class TestMaintenanceSweep:
    ...
    async def test_maintenance_sweep_success(self):
        ...
        with (
            ...
            # Realized savings query result -> empty; archive SQL execute -> None.
            empty_result = MagicMock()
            empty_result.scalars.return_value.all.return_value = []
            mock_session.execute = AsyncMock(side_effect=[empty_result, None])
...
class TestSchedulerTasksProductionQuality:
    ...
    async def test_maintenance_sweep_archive_operation(self):
        ...
        with (
            ...
            assert any(
                "archive_old_cost_partitions" in str(call.args[0])
